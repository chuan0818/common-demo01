...
#示例: bash <(curl -s -L http://zhuzc.cn1.utools.club/gituseful.sh) 
#下载: curl -O http://zhuzc.cn1.utools.club/gituseful.sh
#用法: 定制合并分支的选项
...
echo 1.hyt_v130_20210402_b01合并到test
echo 2.hyt_v130_20210402_b01合并到test3
read -p "请选择：" input
case $input in
	[1])
		LOCAL_BRANCH=hyt_v130_20210402_b01
		TARGET_BRANCH=test
		;;
	[2])
		LOCAL_BRANCH=hyt_v130_20210402_b01
